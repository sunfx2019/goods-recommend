package com.yimai.web.security.encryption;
...
public class MD5 {
	...
	public static void main(String args[]) {
		MD5 m = new MD5();
		System.out.println("To -->MD5:" + m.getMD5ofStr("12345"));
		if (Array.getLength(args) == 0) { //如果没有参数，执行标准的Test Suiteִ�б�׼��Test Suite
			...
			System.out.println("MD5(\"abc\"):" + m.getMD5ofStr("abc"));
			System.out.println("MD5(\"12345\"):" + m.getMD5ofStr("12345"));
			...
			System.out.println("MD5(\"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789\"):" + m .getMD5ofStr("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789"));
			System.out.println("MD5(\"1234567890\"):" + m.getMD5ofStr("1234567890"));
		} else{
